...
parent_dir <- getwd()
dir_path <- paste0(parent_dir, "/results_combinations/fundamental_estimate_actual_ratio_mult_sum")
...
#   chr.path <- paste0(parent_dir, "/test_combinations/fundamental_estimate_actual_ratio_sum/", dt.temp$alpha_id)
